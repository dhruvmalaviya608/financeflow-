...
const NavLink = ({
  ...
  <Link
    ...
    className={cn(
      ...
      isActive && 'text-primary-foreground bg-gradient-to-r from-violet-500 to-fuchsia-500 shadow-lg hover:text-primary-foreground'
    )}
  >
    {icon}
    {children}
    ...
    <div className="flex h-full max-h-screen flex-col gap-2 bg-card border-r">
      <div className="flex h-14 items-center border-b px-4 lg:h-[60px] lg:px-6">
        <Link href="/" className="flex items-center gap-2 font-semibold">
          <img src="/assets/logo.png" alt="FinanceFlow Logo" className="h-8 w-8" />
